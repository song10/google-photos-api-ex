...
class GooglePhotos:
    ...
    def initService(self):
        self.service = Create_Service(
            GooglePhotos.CLIENT_SECRET_FILE, GooglePhotos.API_NAME, GooglePhotos.API_VERSION, GooglePhotos.SCOPES)
        self.client_token = pickle.load(
            open('token_photoslibrary_v1.pickle', 'rb'))
    ...
    def upload_image(self, image_path):
        try:
            ...
            headers = {'Authorization': 'Bearer ' + self.client_token.token,
                       ...
                       'X-Goog-Upload-File-Name': file_base_name}
...
class GooglePhotoApp(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(r'icons8-cute-color-64.png'))
        ...
        button_upload.clicked.connect(self.upload_photos)
    ...
    def upload_photos(self):
        ...
        new_media_items = [{'simpleMediaItem': {
            'uploadToken': tok}} for tok in tokens]
